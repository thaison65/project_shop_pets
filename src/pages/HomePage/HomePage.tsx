...
const HomePage: React.FC<HomePageProps> = () => {
  ...
  return (
    <>
      ...
      <section id='container-banner' className='flex justify-between gap-7 bg-primary-dark-blue-80 rounded-[20px] overflow-hidden pt-9 pl-5 '>
        <img src={imgBanner} alt='image banner' className='w-[513px] h-[342px]' loading='lazy' />
        <div className='relative flex flex-col gap-2'>
          <div className='absolute -top-[70%] -right-[40%] w-[782px] h-[635px] bg-secondary-mon-yellow-40 rounded-[99px] rotate-[25.23deg]'></div>
          <div className='relative z-10 flex items-center justify-center mr-24'>
            <div className='w-[403px] flex flex-col items-end'>
      ...
      <section id='container-seller' className='flex flex-col gap-7'>
        <AccordionHeader title='Pet Sellers' subtitle='Proud to be part of' buttonText='View all our sellers' flexContent='flex items-center gap-2' />
      ...
      <section id='container-knowledge' className='flex flex-col gap-7'>
        ...
        <div className='flex flex-wrap gap-7'>
          {knowledges.map((knowledge) => (
            <div
              key={knowledge.id}
              className='flex flex-col w-full sm:w-[calc(50%-14px)] lg:w-[calc(33.333%-19px)] items-center gap-10 p-2 rounded-xl shadow-1'>
